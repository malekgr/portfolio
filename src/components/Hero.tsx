      ...
      <div className="container mx-auto px-6 z-10">
        <div className="flex flex-col items-center justify-center gap-8 mt-16 sm:mt-0">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="w-40 h-40 md:w-48 md:h-48 rounded-full overflow-hidden border-4 border-blue-500/30 glow">
              <Image
                src="/malekPic.jpg"
          ...
          <div className="text-center max-w-xl">
            ...
            <motion.h1
              ...
              className="text-4xl md:text-6xl font-bold mb-4 gradient-text glow-text"
            >
              {personalInfo.name}
            </motion.h1>
            ...
            >
              <a
                href="#contact"
                className="px-8 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg font-medium transition-all duration-300 hover:shadow-lg hover:shadow-blue-600/30 text-center"
              >
                Get In Touch
              </a>
            </motion.div>
            ...
            >
              <a
                ...
                className="p-3 rounded-full bg-slate-800/50 hover:bg-blue-600/20 border border-slate-700 hover:border-blue-500 transition-all duration-300"
              >
